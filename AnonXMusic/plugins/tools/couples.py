...
@app.on_message(filters.command("كبلز", prefixes=""))
async def ctest(_, message):
    ...
    try:
     ...
     #  if not is_selected:
         msg = await message.reply_text("❖ جـاري عـمـل صـورة للـڪـابـلـز🌝💕.")
         #GET LIST OF USERS
         list_of_users = []
         ...
         img = Image.open("AnonXMusic/assets/annie/ANNIECP.png")
