...
@app.on_message(
    filters.command(["الاوامر","اوامر مارڤين"], "")
& filters.group
 )
async def mmmezat(client, message):
        await message.reply_text(f"""**مرحبآ بك عزيزي » {message.from_user.mention}**في قسم مميزات سورس مارڤين ميوزك\n
⩹━★⊷⌯⌞ 𝐒𝐨𝐔𝐫𝐂𝐞 𝐌𝐚𝐑𝐯𝐄𝐧 ⌝⌯⊶★━⩺

★قايمه اوامر سورس مارڤين 
